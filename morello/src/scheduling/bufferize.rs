...
use crate::target::{Target, MEMORY_COUNT, ZERO_LIMITS};
...
impl<Tgt: Target> ActionT<Tgt> for Bufferize<Tgt> {
    fn apply_unchecked_canon(&self, spec: &Spec<Tgt>) -> Result<ImplNode<Tgt>, ApplyError> {
        ...
        let buffer_cost: [u64; MEMORY_COUNT] = Tgt::memories().map(|l| {
            if self.memory == l {
        ...
        let check_oom =
            |before: &[u64; MEMORY_COUNT], after: &[u64; MEMORY_COUNT]| -> Result<(), ApplyError> {
...
mod tests {
    ...
    use crate::target::{Avx2Target, CpuMemory, MEMORY_COUNT};
    ...
    fn buffer_cost_at_gl(spec: &Spec<Avx2Target>) -> [u64; MEMORY_COUNT] {
