    ...
    P: NaiveBottomUpActionProvider<Tgt>,
{
    ...
    fn request(&mut self, dependents: &SpecGeometry<Tgt>) -> Self::Request {
        ...
        let mut requests = SpecGeometry::new(Rc::clone(dependents.bimap()));
        ...
        ($mksolver:expr, $tgt:ty, $suffix:ident) => {
            paste::paste! { proptest::prelude::proptest! {
                ...
                fn [< test_bottomupsolver_queries_for_single_canonical_spec_are_canonical_ $suffix >](
                    ...
                    use $crate::scheduling::{BottomUpSolver, DependencyRequest};
        ...
        ($tgt:ty, $provider:ty, $suffix:ident) => {
            ...
            paste::paste! { proptest::prelude::proptest! {
                ...
                fn [< test_naivebottomupsolver_queries_for_single_canonical_spec_ $suffix >](
                    ...
                    use $crate::spec_geometry::SpecGeometry;
                    use $crate::scheduling::{
                        BottomUpSolver, NaiveBottomUpSolver, DependencyRequest
                    };
                ...
                fn [< test_naivebottomupsolver_computes_same_decision_for_single_canonical_spec_ $suffix >](
                    ...
                    use $crate::spec_geometry::{SpecGeometry, SpecGeometryRect};
                    use $crate::scheduling::{
                        ActionEncodeDecode, Cost, BottomUpSolver, NaiveBottomUpSolver,
                        DependencyRequest, compute_impl_cost
                    };
                    use $crate::search::ImplReducer;
